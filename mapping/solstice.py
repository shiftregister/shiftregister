...
- used now for sunrise / solstices 
...
timezone_offset = 3   # time offset from UTC time [hours] - 3 for Greece
...
for i in range(2018, 2118, 1): #? was (2018, 12018, 100)?
    ...
    #    print str(sunrise)+"|LINESTRING("+str(longitude)+" "+str(latitude)+","+str(lon)+" "+str(lat)+")" # notes this is OUR localtime in GERMANY - THIS ONE TO USE!
...
for i in data:
    ...
    if altitude_deg > -0.5:
        ...
        #print (timestamp+timedelta(timezone_offset)).strftime('%H:%M')+"|LINESTRING("+str(longitude)+" "+str(latitude)+","+str(lon)+" "+str(lat)+")" # for suns
        print str(timestamp)+"|LINESTRING("+str(longitude)+" "+str(latitude)+","+str(lon)+" "+str(lat)+")" # for suns
        ...
        #        print (timestamp+timedelta(timezone_offset)).strftime('%H:%M')
               ...
               # and if we want say sunrises for the month of may/june - next 30 days
